...
转自：http://www.cnblogs.com/ityouknow/p/5714703.html
...
![jvm-jhat-excluding-paltform](./img/jvm-jhat-excluding-paltform.png)

Show heap histogram 以树状图形式展示堆情况。如下图：

![jvm-jhat-heap-histogram](./img/jvm-jhat-heap-histogram.png)
