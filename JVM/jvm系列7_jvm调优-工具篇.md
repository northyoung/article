...
![jvisualvm.jpg](./img/jvisualvm.jpg)
...
![jvisualvm01.jpg](./img/jvisualvm01.jpg)

VisualVM可以根据需要安装不同的插件，每个插件的关注点都不同，有的主要监控GC，有的主要监控内存，有的监控线程等。

![jvisualvm02.jpg](./img/jvisualvm02.jpg)
...
![mat02.jpg](./img/mat02.jpg)

- Dominator Tree：列出最大的对象以及其依赖存活的Object （大小是以Retained Heap为标准排序的）

![mat03.jpg](./img/mat03.jpg)

- Top Consumers ： 通过图形列出最大的object

![mat04.jpg](./img/mat04.jpg)

- duplicate classes ：检测由多个类装载器加载的类
- Leak Suspects ：内存泄漏分析

![mat05.jpg](./img/mat05.jpg)

- Top Components: 列出大于总堆数的百分之1的报表。

![mat06.jpg](./img/mat06.jpg)
